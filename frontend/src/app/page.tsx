...
export default function Home() {
  ...
  const fetchData = async () => {
    ...
    try {
      // Changed from NEXT_PUBLIC_BACKEND_API_URL to BACKEND_API_URL
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        {data && (
          <div className="mt-4 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-md">
            <h2 className="text-lg font-semibold">{data.message}</h2>
            <p className="text-gray-600">{data.timestamp}</p>
          </div>
        )}
      </main>
